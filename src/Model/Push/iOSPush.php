...
class iOSPush extends iOS
{
    ...
    public function __construct($message, $tokens, $urlScheme = '', $image = '')
    {
        ...
        $this->preparePayload($message, $urlScheme, $image);
    }
    ...
    private function preparePayload($message, $urlScheme, $image)
    {
        ...
        if( $image ){
            $this->payload['mediaUrl'] = $image;
            $this->payload['mediaType'] = 'image';
            $this->payload['aps']['mutable-content'] = 1;
            $this->payload['aps']['category'] = 'custom-push';
        }
